...
class AddRouteActivity : AppCompatActivity(), OnMapReadyCallback,View.OnClickListener{
    ...
    lateinit var openModalIv:ImageView
    lateinit var routesSelRv: RecyclerView
    ...
    lateinit var clearSearchIv : ImageView
    var inserted= false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        openModalIv= findViewById(R.id.openModalIv)
        clearSearchIv= findViewById(R.id.clearSearchIv)
        openModalIv.setOnClickListener(this)
    ...
    fun addRoute() {
        estimateFareAmt= view.findViewById<TextInputEditText>(R.id.fareAmtEdit)?.text.toString().toDouble()
        if(estimateFareAmt < 1)
            ...
            if(startingCoordinate!= null && endingCoordinate != null){
                ...
                Toast.makeText(this,"Can not map the searched location, make sure the location is available in google maps", Toast.LENGTH_SHORT).show()
            }
    ...
    fun geoCode(area: String):LatLng{
        ...
        val geocoder = Geocoder(this@AddRouteActivity)
        try {
        ...
        try{
            ...
            Toast.makeText(applicationContext,"Something went wrong, more precise to locate the location", Toast.LENGTH_SHORT).show()
        }
    ...
    fun showBottomSheet(){
        ...
        view = layoutInflater.inflate(R.layout.layout_add_route_modal, null)
        routesSelRv= view.findViewById(R.id.routesSelectRv)
        ...
        view.findViewById<TextView>(R.id.distanceValueTv).text= distanceValue + " km"

        view.findViewById<Button>(R.id.addRouteBtn).setOnClickListener{
            TODO()
        }
        ...
        view.findViewById<TextView>(R.id.timeValueTv).text=time.toString()+ " "
