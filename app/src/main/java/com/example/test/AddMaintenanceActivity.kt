...
class AddMaintenanceActivity : AppCompatActivity(), View.OnClickListener, OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_add_maintenance)
    ...
    fun addMaintenance(){
        ...
        val newMaintenance =  MaintenanceAdd(userId!!,
        ...
        if (v != null) {
            when (v.id) {
                R.id.back_button_img -> {
                    val i = Intent(this@AddMaintenanceActivity, MaintenancesActivity::class.java)
                    startActivity(i)
                    animate()
                }
    ...
    fun showProgressDialog() {
        ...
        Handler().postDelayed( {
            dialog.dismiss()
            if(inserted)
                Toast.makeText(applicationContext,"Maintenance scheduled!", Toast.LENGTH_SHORT).show()
            else
